...
from . import custom_filter, anjani
from .core.plugin_extender import UnknownPluginError
...
async def _mod(
    ...
    for _, cls in anjani.plugins.items():
...
def on_command(
    ...
    def decorator(func: Callable) -> callable:
        ...
        async def wrapper(_: Client, message: Message) -> None:
            return await _mod(func, message)

        anjani.client.add_handler(MessageHandler(wrapper, filters=_filters), group)
        return func
...
def on_message(
    ...
    def decorator(func: Callable) -> callable:
        ...
        anjani.client.add_handler(MessageHandler(wrapper, filters=filters), group)
        return func
...
def on_callback_query(
    ...
    def decorator(func: Callable) -> callable:
        ...
        anjani.client.add_handler(CallbackQueryHandler(wrapper, filters=filters), group)
        return func
